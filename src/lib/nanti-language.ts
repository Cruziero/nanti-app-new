const EXPANSIONS: Record<string, string> = {
  ...
  blg: "bilang",
  sekolah: "sekolah",
  // di- passive forms (very common in chat)
  dikirim: "kirim",
  dikirimkan: "kirim",
  dikirimin: "kirim",
  dibayar: "bayar",
  ...
  dikerjain: "kerjakan",
  dikerjakan: "kerjakan",
  diselesaikan: "selesaikan",
  diselesaikin: "selesaikan",
  didatangi: "datangi",
  didatengin: "datangi",
  disamain: "samakan",
  // -in casual suffix forms
  kirimin: "kirim",
  kirimkan: "kirim",
  bayarin: "bayar",
  bayarkan: "bayar",
  ...
  ddl: "deadline",
  duedate: "deadline",
  // download/upload/update/confirm borrowing
  donlot: "download",
  donlod: "download",
  update: "update",
  updated: "update",
